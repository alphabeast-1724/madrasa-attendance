  ...
  public: {
    Tables: {
      ...
      profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_assigned_class"
    ...
    Functions: {
      get_assigned_class: { Args: { _user_id: string }; Returns: string }
      has_role: {
        Args: {
      ...
      submit_daily_attendance: {
        Args: { p_absentee_ids: string[]; p_class_id: string; p_date: string }
        Returns: undefined
      }
    }
    Enums: {
      app_role: "admin" | "staff" | "office"
    }
    CompositeTypes: {
      [_ in never]: never
    }
